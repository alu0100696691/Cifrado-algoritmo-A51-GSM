...
#include "../../../../../../../Escritorio/practica3/gsm/gsm.h"
...
struct qt_meta_stringdata_GSM_t {
    QByteArrayData data[4];
    char stringdata[43];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_GSM_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_GSM_t qt_meta_stringdata_GSM = {
    {
...
QT_MOC_LITERAL(3, 22, 19)
    ...
    "GSM\0on_salir_clicked\0\0on_ejecutar_clicked\0"
};
...
void GSM::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_ejecutar_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject GSM::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_GSM.data,
      qt_meta_data_GSM,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GSM.stringdata))
